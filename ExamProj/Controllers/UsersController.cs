...
namespace ExamProj.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,UserName,Password,Email,FirstName,LastName,PersonalNumber,Address,PhoneNumber")] ApplicationUser user, string role)
        {
